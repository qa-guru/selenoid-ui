 ...
 * @returns {string | null}
 */
function hashHrefToPath(href: any) {
 ...
 */
function syncActiveNav(pathname: any) {
    ...
    for (const link of links) {
        ...
        if (isActive) {
            ...
            (link as HTMLElement).dataset.headerActive = "true";
        } else {
            link.removeAttribute("aria-current");
            delete (link as HTMLElement).dataset.headerActive;
        }
    }
    return true;
}
