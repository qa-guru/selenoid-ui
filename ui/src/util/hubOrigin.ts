...
export function stripHubPath(value: unknown): string {
...
export function originFromProp(origin: unknown): string {
...
export function isInternalHubHost(hostname: unknown): boolean {
 ...
 */
export function resolveHubOrigin(origin?: string | null, pageOrigin?: string | null): string {
    const page =
        pageOrigin ||
...
export function hubRemoteUrl(origin?: string | null, pageOrigin?: string | null): string {
...
export function hubSessionUrl(origin?: string | null, authToken?: unknown, pageOrigin?: string | null): string {
