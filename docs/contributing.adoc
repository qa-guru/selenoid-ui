...
WARNING: **Deprecated AsciiDoc.** Сборка и запуск — в корневом link:../README.md[README.md] (Go **1.26.6**, `qaguru/*` images).
...
3) Build (requires Golang **1.26.6**, see `.go-version` / `go.mod`):
