...
WARNING: **Deprecated AsciiDoc.** Сборка и запуск — в корневом link:../README.md[README.md] (Go **1.27.0**, `qaguru/*` images).
...
3) Build (requires Golang **1.27.0**, see `.go-version` / `go.mod`):
