...
**GitHub:** https://github.com/qa-guru/selenoid-ui/releases/tag/v2.2.1 _(tag при cut)_  
...
1. Commit docs на `main` → `git tag -a v2.2.1 -m "v2.2.1"` → push tags _(по команде)_.
